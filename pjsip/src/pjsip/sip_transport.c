 ...
 */
char *
mystrcasestr (char *haystack, char *needle)
{
...
static int checkStatusPacket(char *msgPacket)
{
	if(strstr(msgPacket,"200"))
	{
		char *p;
		p = mystrcasestr(msgPacket,"contact:");
		if(p)
		{
			char *q;
			int x = 0;
			...
			*dm = 0;
			//printf("\n\n\n I got original msg %s\n\n",msgPacket);
			
			//printf("I got new %s\n\n\n",q);
			strcpy(msgPacket,q);
			//printf("\n\n\n I got msg %s\n\n",msgPacket);
			free(q);
			return strlen(msgPacket);
...
//char testStringP[500] = "SIP/2.0 401 Unauthorized\r\nVia: SIP/2.0/UDP 192.168.2.2:9240:10473;rport=10459;branch=z9hG4bKPj3AHTFMdeeQM1aNeLv-xMphtMLeq7EhBN\r\nFrom: <sip:8626589@spokn.com>;tag=cbnxirA3.w7RIBGh67X2h4V64fNckbNw\r\nTo: <sip:8626589@spokn.com>;tag=5e6183cf48af2c5207c27dd61a81b59a.3f9b\r\nCall-ID: 6ex0OsBR6cwXw0tA.Wy7MUib4zV.OFrZ\r\nCSeq: 30034 REGISTER\r\nWWW-Authenticate: Digest realm=\"spokn.com\", nonce=\"4c3b49eb2808a09d66ab72b32e27cbee1fd35813\"\r\nServer: OpenSER (1.2.3-notls (i386/linux))\r\nContent-Length: 0\r\nWarning: 392 64.39.3.65:5060 \"Noisy feedback tells:  pid=1988 req_src_ip=120.60.133.253 req_src_port=10459 in_uri=sip:spokn.com out_uri=sip:spokn.com via_cnt==1\""
//;
/*char testStringP[500] = "SIP/2.0 401 Unauthorized\r\n
Via: SIP/2.0/UDP 192.168.2.2:9240:10473;rport=10459;branch=z9hG4bKPj3AHTFMdeeQM1aNeLv-xMphtMLeq7EhBN\r\n
From: <sip:8626589@spokn.com>;tag=cbnxirA3.w7RIBGh67X2h4V64fNckbNw\r\n
...
Warning: 392 64.39.3.65:5060 \"Noisy feedback tells:  pid=1988 req_src_ip=120.60.133.253 req_src_port=10459 in_uri=sip:spokn.com out_uri=sip:spokn.com via_cnt==1\"
";*/
static int checkViaPacket(char *msgPacket)
{
	//if(strstr(msgPacket,"200"))
	{
		char *p;
		p = mystrcasestr(msgPacket,"Via:");
		if(p)
		{
			char *q;
			int x = 0;
					       ...
					       pjsip_rx_data *rdata)
{
	...
	newLen = checkViaPacket(current_pkt);
	if(newLen)
	{
		rdata->pkt_info.len = newLen;
		
	}
	newLen = checkStatusPacket(current_pkt);
	if(newLen)
	{
		rdata->pkt_info.len = newLen;
