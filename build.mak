...
export PJDIR := /Users/tasvir/documents/mygit/pjproject
export APP_CC := /Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin10-gcc-4.0.1
export APP_CXX := /Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin10-g++-4.0.1
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-O2 -Wno-unused-label  -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.0.sdk\
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	-O2  -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.0.sdk -framework AudioToolbox -framework Foundation
export APP_LDLIBS := -lpjsua-$(TARGET_NAME)\
	...
	$(APP_THIRD_PARTY_EXT)\
	-lpj-$(TARGET_NAME)\
	-lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-O2 -Wno-unused-label  -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.0.sdk
